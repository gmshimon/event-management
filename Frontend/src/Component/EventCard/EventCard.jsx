    ...
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center text-gray-600 mb-3">
          ...
          <div>
            <span className="text-sm font-medium text-gray-800">by {event.organizer}</span>
          </div>
        </div>
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span className="text-sm line-clamp-1 font-medium">{event.location}</span>
          </div>
        </div>
        ...
        >
          <svg className="w-5 h-5 mr-2 transition-transform duration-300 group-hover/button:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
