...
isUpdateEventSuccess,
  ...
  useEffect(() => {
    ...
    if (isDeleteEventError||isUpdateEventError) {
      showToastMessage(error, "error");
    }
    dispatch(resetEventState());
  }, [dispatch, error, isDeleteEventError, isDeleteEventSuccess, isUpdateEventError, isUpdateEventSuccess]);
  ...
  const handleUpdateEvent = (updatedEvent) => {
    ...
    dispatch(updateEvent({id:updatedEvent._id,updateData:updatedEvent}))
  ...
  if (isGetMyEventLoading || isDeleteEventLoading||isUpdateEventLoading) {
    return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Manage and track all the events you've created. Edit details,
            monitor attendance, or remove events as needed.
          </p>
        </div>
        ...
        {myEvents.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            {myEvents?.map((event) => (
              <div
                key={event._id}
                className="bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border border-gray-100"
              >
                {/* Event Header */}
            ...
            <div className="bg-white rounded-3xl p-8 max-w-md w-full mx-4 transform transition-all duration-300 scale-100">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mb-8">
                  This action cannot be undone and all attendee data will be
                  lost.
                </p>
