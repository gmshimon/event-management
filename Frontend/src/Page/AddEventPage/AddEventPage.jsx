          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Use descriptive titles that clearly communicate what your event is about.</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="bg-blue-100 rounded-full p-2 mr-4 mt-1">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-1">Detailed Description</h4>
                <p className="text-gray-600 text-sm">Include agenda, requirements, and what attendees can expect.</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="bg-blue-100 rounded-full p-2 mr-4 mt-1">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-1">Accurate Location</h4>
                <p className="text-gray-600 text-sm">Provide complete address or venue details for easy navigation.</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="bg-blue-100 rounded-full p-2 mr-4 mt-1">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-1">Realistic Capacity</h4>
                <p className="text-gray-600 text-sm">Set appropriate attendee limits based on your venue and resources.</p>
              </div>
            </div>
          </div>
        </div>
